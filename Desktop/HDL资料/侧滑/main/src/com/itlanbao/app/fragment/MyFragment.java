...
import com.itlanbao.app.activity.BaseActivity;
import com.itlanbao.app.application.Constant;
import com.itlanbao.app.tabhost.FragmentInterface;
...
//		this.getActivity().finish();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && isSaveState()) {
            isOnInit = savedInstanceState.getBoolean(com.itlanbao.app.application.Constant.KEY_TAB_INIT);
        }
