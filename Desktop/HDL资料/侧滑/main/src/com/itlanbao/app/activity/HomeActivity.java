...
import com.itlanbao.app.entity.TabMode;
import com.itlanbao.app.fragment.InfomationFragment;
import com.itlanbao.app.fragment.HomeFragment;
import com.itlanbao.app.fragment.SearchFriendFragment;
...
public class HomeActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 侧滑布局
		menuListView.setAdapter(new SimpleAdapter(this, data, R.layout.wxtong_leftitem,
				new String[] { "item", "image", "iv" }, new int[] { R.id.tv_item, R.id.iv_item, R.id.iv }));
	...
	private void initView() {
		...
		{// 缘分
			final TabMode tabMode = new TabMode(HOME_TAB, R.drawable.tab_1_selector, "首页",
					R.color.tab_text_color_selector, new HomeFragment(), code == 1);
			listTabModes.add(tabMode);
		}

		{// 搜索
			final TabMode tabMode = new TabMode(SEARCH_TAB, R.drawable.tab_2_selector, "搜索",
					R.color.tab_text_color_selector, new SearchFriendFragment(), code == 2);//
			listTabModes.add(tabMode);

		}

		{// 消息
			final TabMode tabMode = new TabMode(HOME_TAB_MESSAGE, R.drawable.tab_3_selector, "信息",
					R.color.tab_text_color_selector, new InfomationFragment(), code == 3);
			listTabModes.add(tabMode);
		}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			...
			builder.setMessage("确定要退出吗？").setCancelable(false)
